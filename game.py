...
class TicTacToe:
    ...
    def print_caption(self):
        game_over = self.winner is not None or self.game_steps == 9
        pg.display.set_caption(f'Player "{"OX"[self.player]}" turn!' if not game_over else f'Player "{self.winner}" wins! Press Space to Restart')
